...
final List<OtherCategoryEntity> othersCategories = [
  OtherCategoryEntity(
    id: 1,
  ...
  OtherCategoryEntity(
    ...
    // Fixed: Reverted to woman.png as per UI requirement, logic handles hijab.png in details
...
const List<OtherItemEntity> othersItems = [
  OtherItemEntity(
    id: 1,
