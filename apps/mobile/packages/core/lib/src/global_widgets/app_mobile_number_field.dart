...
class AppMobileNumberField extends StatefulWidget {
  ...
  const AppMobileNumberField(
      {super.key, this.description, this.hintText, this.title});
...
class _AppMobileNumberFieldState extends State<AppMobileNumberField> {
  ...
  final ValueNotifier<String> flagImagePath =
      ValueNotifier<String>('packages/core/assets/flags/ukraine.svg');
      ...
      prefixIcon: DropdownButtonHideUnderline(
        child: DropdownButton2<String>(
          ...
          onChanged: (value) => value != null
              ? flagImagePath.value = 'packages/core/assets/flags/$value.svg'
              : null,
...
final List<Country> countries =
    countryNames.map((name) => Country(name, '+123')).toList();
