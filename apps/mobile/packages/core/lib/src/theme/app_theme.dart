...
class AppTheme {
  ...
  AppBarTheme appBarTheme(ColorScheme scheme) =>
      AppBarTheme(
          ...
          iconTheme: IconThemeData(
              size: 24.r, color: scheme.onPrimary));
  ...
  ///TabBarTheme
  TabBarTheme tabBarTheme(ColorScheme scheme) =>
      TabBarTheme(
  ...
  ///dialogTheme
  DialogTheme dialogTheme({required bool isDark}) =>
      const DialogTheme(
  ...
  BottomNavigationBarThemeData bottomNavigationBarTheme(
      ...
      BottomNavigationBarThemeData(
        ...
        unselectedIconTheme: IconThemeData(
            size: 25, color: scheme.secondary),
        selectedIconTheme:
  ...
  InputDecorationTheme inputDecoration(
    ...
    return const InputDecorationTheme(
      ...
      constraints:
          BoxConstraints(maxHeight: 56, minHeight: 56),
      // filled: true,
      // labelStyle: isDark
